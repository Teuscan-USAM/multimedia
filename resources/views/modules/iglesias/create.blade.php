        ...
        <form method="POST" action="{{ route('iglesias.store') }}">
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6">
              ...
              <select name="pastor_id" class="form-select">
                ...
                @foreach($pastores as $pastor)
                  <option value="{{ $pastor->id }}" @selected(old('pastor_id') == $pastor->id)>{{ $pastor->name }} ({{ $pastor->email }})</option>
                @endforeach
              </select>
            </div>
            <div class="col-12">
            ...
            <div class="col-12">
              ...
              <input type="url" name="direccion_google_maps" class="form-control" value="{{ old('direccion_google_maps') }}" placeholder="Pega aquí el enlace de Google Maps">
