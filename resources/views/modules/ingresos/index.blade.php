    ...
    <div class="card">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mt-3">
          ...
          <a class="btn btn-primary" href="{{ route('ingresos.create') }}">
            ...
            <tbody>
              @foreach($items as $it)
                <tr>
                  ...
                  <td class="text-end">
                    <a class="btn btn-sm btn-warning" href="{{ route('ingresos.edit', $it->id) }}">Editar</a>
                    <form class="d-inline" method="POST" action="{{ route('ingresos.destroy', $it->id) }}" onsubmit="return confirm('¿Eliminar este ingreso?');">
                      @csrf
                      @method('DELETE')
