  ...
  <section class="section">
    <div class="card">
      <div class="card-body">
        ...
        <form method="POST" action="{{ route('ingresos.update', $item->id) }}">
          @csrf
          @method('PUT')
          ...
          <div class="row g-3">
            ...
            <div class="col-md-4">
              ...
              <input name="monto" type="number" min="0.01" max="9999999999.99" step="0.01" inputmode="decimal" class="form-control" value="{{ old('monto', $item->monto) }}" placeholder="Ejemplo: 00.00" required>
